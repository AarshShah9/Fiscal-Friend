...
const savingOptions= (savingAccount: SavingAccountType) => {
    return {
        ...
        series: [{
            name: "Money in CAD",
            data: [savingAccount.chequing, savingAccount.savings, savingAccount.resp]
        }],
        xaxis: {
        ...
        <div className="flex-col items-center justify-center pt-80">
            <div className="flex justify-center items-center">
                <div className="bg-[#D1FAE5] bg-opacity-25 flex justify-center h-36 w-3/5 p-4 border-[1.5px] border-[#10B981]">
                    <div>
                        <p><u>Summary of Savings</u></p>
                        <ul className="text-center">
                            <li><b>Chequing:</b> ${savingAccount.chequing}</li>
                            <li><b>Savings:</b> ${savingAccount.savings}</li>
                            <li><b>RESP:</b> ${savingAccount.resp}</li>
                        </ul>
                    </div>
                </div>
            </div>
