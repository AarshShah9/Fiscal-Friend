...
export default function AboutUs() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm: min-h-screen">
      ...
      >
        <div
          className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#44d48c] to-[#18804c] opacity-20"
          style={{
            clipPath:
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            We are a team of financial experts who are dedicated to helping you
            build wealth. We provide the best in class financial services to
